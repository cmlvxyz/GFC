...
export const UploadPage: React.FC<UploadPageProps> = ({ apiUrl }) => {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4">
        <div className="bg-white rounded-3xl max-w-md w-full p-8 text-center shadow-2xl border border-gray-200">
          ...
          <h2 className="text-xl font-bold text-black mb-2">Invalid QR Code</h2>
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 p-4">
        <div className="max-w-2xl mx-auto">
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden">
            {/* Success header */}
            <div className="text-center py-7 px-4 border-b border-gray-100">
              <div className="w-14 h-14 mx-auto bg-emerald-100 rounded-full flex items-center justify-center mb-2">
            ...
            <div className="p-5 pt-0 flex flex-wrap gap-2 justify-center">
              ...
              <button
                onClick={handleExit}
                className="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-bold transition-all flex items-center gap-2"
              >
                <X className="w-4 h-4" />
                Exit
              </button>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-3xl max-w-md w-full p-6 md:p-8 shadow-2xl border border-gray-200">
        {/* Header */}
        <div className="text-center mb-6">
          <div className="w-16 h-16 mx-auto rounded-full bg-indigo-100 flex items-center justify-center mb-3 overflow-hidden">
            <img src="/logo.png" alt="GFC" className="w-full h-full object-cover" />
          </div>
          <h1 className="text-2xl font-serif text-black">Gospel Fellowship Church</h1>
          <p className="text-xs text-gray-500 mt-1">Photo Upload</p>
        </div>

        {/* Event Info */}
        <div className="bg-indigo-50 rounded-xl p-4 mb-6 border border-indigo-200">
          <div className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Uploading to:</div>
          <div className="font-bold text-black">{eventTitle || 'Event'}</div>
          <div className="text-sm text-gray-600">{dateTitle || 'Album'}</div>
        </div>
        ...
        {/* Error Message */}
        {errorMessage && (
          <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-xl text-red-700 text-sm flex items-start gap-2">
        ...
        <button
          ...
          className="w-full mt-4 py-3.5 bg-indigo-500 hover:bg-indigo-600 text-white font-extrabold rounded-xl text-sm transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 shadow-lg"
        >
          {isUploading ? (
            <>
