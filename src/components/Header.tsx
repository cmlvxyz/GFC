  ...
  return (
    <header className="absolute inset-x-0 top-4 z-40">
        ...
        <Link
          to="/"
          onClick={closeMobile}
          className="relative -left-40 flex items-center gap-5 group shrink-0"
        >
            <div className="w-12 h-12 lg:w-25 lg:h-25 rounded-full overflow-hidden ring-1 ring-white/25 shadow-md bg-white/90 flex items-center justify-center group-hover:scale-105 transition-transform duration-300">
            <img
              src="/logo.png"
          ...
          <span
            className="font-serif tracking-tight text-white text-xl md:text-6xl lg:text-4xl leading-tight whitespace-nowrap"
        ...
        <nav className="relative left-40 hidden lg:flex items-center gap-7">
          {navLinks.map(link => {
          ...
          <button
            ...
            className="group relative flex items-center gap-1.5 text-lg font-bold text-indigo-400 hover:text-white py-1 transition-colors duration-300"
          >
